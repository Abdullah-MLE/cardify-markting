...
class ContentService(BaseService):
    ...
    def create_single_post(self, company_id: int, template_id: int, h1: str, notes: str = "") -> ContentResponse:
        ...
        # Step 2: Build Content and insert to DB via CRUD layer
        ...
        content_id = content_crud.create(self.supabase_crud, content_in)
    ...
    def generate_content_media(self, content_id: int, template_id: int, user_prompt: str = None) -> str | list[str]:
        ...
        content = content_crud.get_by_id(self.supabase_crud, content_id)
    ...
    def generate_day_content(self, weekly_plan_id: int, day_order: int, day_name: str, date: str, notes: str = "no notes") -> DayContentGeneration:
        ...
        weekly_plan = weekly_plan_crud.get_by_id(self.supabase_crud, weekly_plan_id)
        company = company_crud.get_by_id(self.supabase_crud, weekly_plan.company_id)
